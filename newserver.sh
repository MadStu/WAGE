...
useradd -m -s /bin/bash wageuser
echo "wageuser:$PASS" | chpasswd
usermod -aG sudo wageuser
...
echo "              reboot"
echo " "
echo " Then log back in with your new wageuser account to complete the installation."
echo " "
